 ...
 */
final class Version20230502222807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, id_categorie_id INT DEFAULT NULL, id_user_id INT DEFAULT NULL, auteur_id INT DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, description VARCHAR(500) DEFAULT NULL, contenu MEDIUMTEXT DEFAULT NULL, date_publication DATE DEFAULT NULL, archived TINYINT(1) DEFAULT NULL, avg_rating DOUBLE PRECISION DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, image_size INT DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_23A0E669F34925F (id_categorie_id), INDEX IDX_23A0E6679F37AE5 (id_user_id), INDEX IDX_23A0E6660BB6FE6 (auteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE authors (id INT AUTO_INCREMENT NOT NULL, auteur_id INT DEFAULT NULL, full_name VARCHAR(255) DEFAULT NULL, date_de_naissance DATE DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, archived TINYINT(1) DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, image_size INT DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_8E0C2A5160BB6FE6 (auteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE categorie_items (id INT AUTO_INCREMENT NOT NULL, nom_categorie VARCHAR(30) DEFAULT NULL, qt INT NOT NULL, archived TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment_items (id INT AUTO_INCREMENT NOT NULL, userid_id INT NOT NULL, itemid INT NOT NULL, comment VARCHAR(300) NOT NULL, INDEX IDX_488471BC58E0A285 (userid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, id_user_id INT DEFAULT NULL, id_categorie_id INT DEFAULT NULL, id_echange_id INT DEFAULT NULL, libelle VARCHAR(30) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, etat VARCHAR(10) DEFAULT NULL, type VARCHAR(10) DEFAULT NULL, imageurl LONGTEXT DEFAULT NULL, likes INT DEFAULT NULL, dislikes INT DEFAULT NULL, views INT NOT NULL, archived TINYINT(1) DEFAULT NULL, INDEX IDX_1F1B251E79F37AE5 (id_user_id), INDEX IDX_1F1B251E9F34925F (id_categorie_id), INDEX IDX_1F1B251EB6FBB8CF (id_echange_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE like_items (itemid INT NOT NULL, userid INT NOT NULL, liked INT NOT NULL, PRIMARY KEY(itemid, userid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, id_reclamation_id INT DEFAULT NULL, titre_reponse VARCHAR(255) DEFAULT NULL, description_reponse VARCHAR(255) DEFAULT NULL, date_reponse DATE DEFAULT NULL, archived TINYINT(1) DEFAULT NULL, avis VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_5FB6DEC7100D1FDF (id_reclamation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reset_password_request (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, selector VARCHAR(20) NOT NULL, hashed_token VARCHAR(100) NOT NULL, requested_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', expires_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7CE748AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, google_authenticator_secret VARCHAR(255) DEFAULT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, avatar_url VARCHAR(255) DEFAULT NULL, image_size INT DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', score INT DEFAULT NULL, archived TINYINT(1) DEFAULT NULL, date_naissance DATE DEFAULT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE view_items (itemid INT NOT NULL, userid INT NOT NULL, PRIMARY KEY(itemid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE comment_items ADD CONSTRAINT FK_488471BC58E0A285 FOREIGN KEY (userid_id) REFERENCES utilisateur (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment_items DROP FOREIGN KEY FK_488471BC58E0A285');
        ...
        $this->addSql('DROP TABLE comment_items');
        ...
        $this->addSql('DROP TABLE view_items');
